...
import { doSignInWithEmailAndPassword, doSignInWithGoogle } from "D:/MUSTAFA'S FOLDER/SEM 7 2024/LY PROJECT 2024/PredictEdge/graphy-pass/src/firebase/auth";
    ...
    const onSubmit = async (e) => {
        ...
        if (!isSigningIn) {
            ...
            try {
                ...
                // toast.error("Credentials are incorrect.", { autoClose: 3000 });
